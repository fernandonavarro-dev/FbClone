...
- [components/Widgets.js](https://) - ...
- [widgets-full](https://) - className="hidden lg:flex flex-col w-60 p-2 mt-5"
- [widgets-top](https://) - className="flex justify-between items-center text-gray-500 mb-5"
- [widgets-contacts-text](https://) - className="text-xl"
- [widgets-contacts-icons](https://) - className="flex space-x-2"
- [components/Contact.js](https://) - ...
- [contact-full](https://) - className="flex items-center space-x-3 mb-2 relative hover:bg-gray-200 cursor-pointer p-2"
- [contact-image](https://) - className="rounded-full"
- [contact-name](https://) - className="font-semibold"
- [contact-status-dot](https://) - className="absolute bottom-2 bg-green-400 h-3 w-3 rounded-full"
- [...](https://) - ...
